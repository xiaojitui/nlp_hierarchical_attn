...
#cut_v = 3330 #3330
#X_train_new = X_train + X_test[:cut_v]
#y_train_new = y_train + y_test[:cut_v]

#X_test_new = X_test[cut_v:]
#y_test_new = y_test[cut_v:]
...
with tf.device('/gpu:3'):
    ...
    with tf.name_scope('logits'):
        optimizer, logits, cost = reg_train_op(final_outputs_drop, y, is_train = is_training, 
                                               ac_fn = tf.nn.tanh, lr = 1e-4, l2reg = 0.01, n_output = 1)
