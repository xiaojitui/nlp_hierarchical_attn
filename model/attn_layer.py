...
def atten_layer_project(outputs, atten_size, n_layer = None, l2reg = 0.0, seq_len = None, use_mask = False, sen_CLS = False, scope = None):
    # atten_layer: 
    ...
    with tf.variable_scope(scope or 'attention') as scope:
        ...
        if use_mask:
            ...
            if sen_CLS:
                ...
                mask = tf.pad(tf.sequence_mask(seq_len - 2, max_len - 1, dtype = tf.float32), paddings, 'CONSTANT')
            else:
...
def atten_layer_weight(outputs, atten_size, n_layer = None, l2reg = 0.0, seq_len = None, use_mask = False, sen_CLS = False, scope = None):
    # atten_layer: 
