...
def read_examples_1(stack_strs, doc_len):
    """Read a list of `InputExample`s from a list of strings."""
    unique_id = 0
...
def convert_lst_to_features_1(lst_str, doc_len, seq_length, tokenizer):
    """Loads a data file into a list of `InputBatch`s."""

    for (ex_index, example) in enumerate(read_examples_1(lst_str, doc_len)):
